...
Funções que recebem e retornam valores (caso mais completo)
...
#+BEGIN_SRC C :tangle a25-menu-retorno.c
#include <stdio.h>
...
#+BEGIN_SRC C :tangle a25-calcula-media-tres.c
#inlude <stdio.h>
...
#+BEGIN_SRC C :tangle a25-imprime-parametros.c
#include <stdio.h>
...
#+BEGIN_SRC C :tangle a25-ascii-parametros.c
#include <stdio.h>
...
fibonacci, retornando o último valor calculado (a posição que foi
pedida).

* (#4) Código ~a25-fibonacci.c~

#+latex: \vspace{-0.3cm}\begin{multicols}{2}
#+BEGIN_SRC C :tangle a25-fibonacci.c
#include<stdio.h>
//protótipo
...
#+BEGIN_SRC C :tangle a25-combinacoes.c
#include<stdio.h>
...
#+BEGIN_SRC C :tangle a25-troca.c
#include <stdio.h>
