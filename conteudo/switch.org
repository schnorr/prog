...
#+begin_src C :tangle a06-mensagem.c
...
#+BEGIN_SRC C :tangle a06-mensagem-switch-case_v1.c
#include <stdio.h>
int main () {
  int cod;
  printf("Codigo (1 a 4): ");
...
#+BEGIN_SRC C :tangle a06-mensagem-switch-case_v2.c
#include <stdio.h>
int main () {
  int cod;
  printf("Codigo (1 a 4): ");
...
#+BEGIN_SRC C :tangle a06-calculadora.c
...
#+attr_latex: :options fontsize=\scriptsize
#+BEGIN_SRC C :tangle a06-preco.c
...
#+BEGIN_SRC C :tangle a06-estado-civil.c
...
#+attr_latex: :options fontsize=\tiny
#+BEGIN_SRC C :tangle a06-notas.c
