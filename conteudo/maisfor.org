...
#+BEGIN_SRC C :tangle a08-fatorial-comeco.c
#include <stdio.h>
int main () {
  int num, fat, i;
...
#+BEGIN_SRC C :tangle a08-fatorial-solucao-1.c
#include <stdio.h>
int main () {
  int num, fat, i, j;
  printf("Entre um numero inteiro positivo: " );
...
#+BEGIN_SRC C :tangle a08-fatorial-solucao-2.c
#include <stdio.h>
int main () {
  int num, fat, i, j;
  printf("Entre um numero inteiro positivo: " );
...
#+BEGIN_SRC C :tangle a08-fibonacci-comeco.c
#include<stdio.h>
int main(){
...
#+BEGIN_SRC C :tangle a08-fibonacci-solucao.c
#include<stdio.h>
int main(){
  int pos, fib, t_1, t_2, i;
  printf("Entre um numero inteiro positivo: " );
...
#+BEGIN_SRC C :tangle a08-ka-ele.c
#include <stdio.h>
int main(){
  int ka, ele;
  for (ka = 1; ka <= 2; ka++)
...
#+BEGIN_SRC C :tangle a08-tabuada.c
...
#+BEGIN_SRC C :tangle a08-newton-raphson.c
...
#+BEGIN_SRC C :tangle a08-maior-menor.c
#include <stdio.h>
#include <limits.h>
#define ELEM 4
int main (){
...
#+BEGIN_SRC C :tangle a08-serie-potencia.c
