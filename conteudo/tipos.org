...
#+BEGIN_SRC C :tangle exemplo-com-biblioteca-math.c
...
#+BEGIN_SRC C :tangle exemplo-tipos-expressoes-aritmeticas.c
...
#+BEGIN_SRC C :tangle exemplo-tipos-expressoes-aritmeticas-cast.c
/* Exemplo para ilustrar um problema com expressoes aritmeticas */
#include <stdio.h>
int main()
{
