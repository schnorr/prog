...
#+latex: \newcommand{\mytitle}{Revisão N12 R1}
#+latex: \mytitleslide
...
- Sistema operacional é concorrente
  - Ou seja, se executa "ao mesmo tempo" que nosso programa
- Não há como antecipar se ela falhará ou não
  - Testar =feof= não garante que uma leitura subsequente funcionará
- Devemos tentar fazer a operação, e verificar seu retorno
