...
#+BEGIN_SRC text :tangle e/dados.txt
...
=a38-convergencia.c=
#+latex: \tiny{
#+BEGIN_SRC C :tangle e/a38-convergencia.c
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
int main() {
  char stringao[256], *pch = NULL; // armazena linha lida
  FILE *arq = NULL;
  char nome[32]; // nome da pessoa
  int codigo;    // código da pessoa
  float n1, n2;  // notas da pessoa
  arq = fopen("dados.txt", "r");
  if (arq == NULL) return 0;
  while (fgets (stringao, sizeof(stringao), arq) != NULL) {
    pch = strtok(stringao, ",");
    codigo = atoi(pch);
    pch = strtok(NULL, ",");
    strncpy(nome, pch, sizeof(nome));
    pch = strtok(NULL, ",");
    n1 = atof(pch);
    pch = strtok(NULL, ",");
    n2 = atof(pch);
